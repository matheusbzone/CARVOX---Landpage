  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const assistantMsg: Message = {
        id: `msg-ast-${Date.now()}`,
        role: "assistant",
        content: data.text || "Desculpe, tive um contratempo interno ao gerar a resposta.",
        timestamp: new Date()
      };
      ...
      const errorMsg: Message = {
        id: `msg-err-${Date.now()}`,
        role: "assistant",
        content: "Desculpe, não consegui obter uma resposta automática do servidor de Inteligência Artificial no momento. Verifique sua conexão ou tente novamente mais tarde.",
        timestamp: new Date()
      };
