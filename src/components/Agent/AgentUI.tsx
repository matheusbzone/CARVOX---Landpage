...
export default function AgentUI({ onClose }: AgentUIProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-md flex flex-col md:flex-row items-center justify-center p-4 sm:p-6 gap-8 select-none font-sans overflow-hidden" onClick={onClose}>
      ...
      <AnimatePresence>
        {status === "connected" && (
          <motion.div 
            ...
            exit={{ opacity: 0, x: -50 }}
            className="hidden md:flex w-full max-w-[400px] bg-white/5 border border-white/10 rounded-[32px] p-6 flex-col gap-4 shadow-2xl backdrop-blur-lg"
