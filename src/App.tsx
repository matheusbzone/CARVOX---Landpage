...
import GovBrCallback from "./components/GovBrCallback";
import GovBrSimulatedLogin from "./components/GovBrSimulatedLogin";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (path === '/callback/govbr' || hash.startsWith('#/callback/govbr')) {
      setIsCallbackRoute(true);
    }
    if (path === '/simulacao-govbr' || hash === '#/simulacao-govbr') {
  ...
  if (isCallbackRoute) {
    return <GovBrCallback />;
  }

  if (isSimulatedLogin) {
    return <GovBrSimulatedLogin />;
  }
